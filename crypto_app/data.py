diff --git a/crypto_app/data.py b/crypto_app/data.py
new file mode 100644
index 0000000000000000000000000000000000000000..a948a147a8c642a42868640eeeb0e73520d2cecd
--- /dev/null
+++ b/crypto_app/data.py
@@ -0,0 +1,156 @@
+import time
+
+import pandas as pd
