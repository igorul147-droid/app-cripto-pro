diff --git a/crypto_app/charts.py b/crypto_app/charts.py
new file mode 100644
index 0000000000000000000000000000000000000000..f3b96d22c12bca68d97dcb23bdaa04d93222be34
--- /dev/null
+++ b/crypto_app/charts.py
@@ -0,0 +1,148 @@
+import json
+
